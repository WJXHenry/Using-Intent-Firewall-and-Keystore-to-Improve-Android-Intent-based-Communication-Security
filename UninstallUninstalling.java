    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            if (savedInstanceState == null) {
                ...
                // IntentFirewall
                // Inject uid of app being uninstalled into intent here through Intent.EXTRA_INTENT_FIREWALL extra field
                Log.d("PackageInstaller", "UninstallUninstalling: uid from appInfo: " + String.valueOf(mAppInfo.uid));
                broadcastIntent.putExtra(Intent.EXTRA_INTENT_FIREWALL, mAppInfo.uid);
                // IntentFirewall
